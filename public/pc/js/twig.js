...
var Twig = (function (Twig) {
    ...
    Twig.output = function(output) {
        ...
        if (Twig.disableEscape) {
            return Twig.Markup(output.join(""));
        }
    ...
    Twig.Template = function ( params ) {
        ...
        if (is('String', data)) {
            this.tokens = function() {return Twig.prepare.apply(this, [data]);};
        } else {
            this.tokens = data;
        }
...
(function() {
    "use strict";
    // Handle methods that don't yet exist in every home
    ...
    **/
    ...
    Twig.lib.strtotime = function (text, now) {
        ...
        function process(val) {
            var splt = val.split(' '), // Todo: Reconcile this with regex using \s, taking into account home issues with split and regexes
                type = splt[0],
...
var Twig = (function (Twig) {
    ...
    Twig.logic.type = {
        ...
        autoescape:  'Twig.logic.type.autoescape',
        endautoescape:  'Twig.logic.type.endautoescape'
    };
    ...
    Twig.logic.definitions = [
        ...
        {
            /*
            * autoescape logic tokens.
            */
            type: Twig.logic.type.autoescape,
            regex: /^autoescape\s+(.+)$/,
            next: [Twig.logic.type.endautoescape],
            open: true,
            parse: function (token, context, chain) {
                var disableEscapeOldValue = Twig.disableEscape;
                switch (token.match[1]) {
                    case 'false':
                        Twig.disableEscape = true;
                        break;
                    default :
                        throw new Twig.Error('unsupported');
                }
                var output = Twig.parse.apply(this, [token.output, context]);
                Twig.disableEscape = disableEscapeOldValue;
                return {
                    chain: chain,
                    output: output
                };
        ...
        {
            type: Twig.logic.type.endautoescape,
            regex: /^endautoescape$/,
            next: [ ],
            open: false
        }
    ...
    Twig.exports.twig = function twig(params) {
        ...
        var id = params.id,
            options = {
                ...
                autoescape: params.autoescape != null && params.autoescape || true,
